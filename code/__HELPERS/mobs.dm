...
/proc/random_tail_hair_style(gender)
	switch(gender)
		if(MALE)
			return pick(GLOB.tail_hair_styles_male_list)
		if(FEMALE)
			return pick(GLOB.tail_hair_styles_female_list)
		else
			return pick(GLOB.tail_hair_styles_list)
